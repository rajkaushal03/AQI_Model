      ...
      <div className=" bg-black">
        ...
        <div className="flex justify-around  items-center xl:gap-54 p-4 md:p-8 bg-neutral">
          <div className='z-2 flex flex-col md:p-4 gap-5 xl:gap-10 justify-center items-start '>
            <div className='flex flex-col xl:gap-4 sm:text-3xl xl:text-5xl font-bold  text-white'>Predictive Modelling to <span>Mitigate</span> <span> Public Health Risks...</span></div>
        ...
        <CityCard />
        <div className=' flex lg:flex-row flex-col gap-4 lg:justify-between lg:items-center p-4  lg:p-8 bg-neutral'>
          <FormSection />
